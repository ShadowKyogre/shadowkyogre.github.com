...
BLOG_AUTHOR = "ShadowKyogre"  # (translatable)
BLOG_TITLE = "ShadowKyogre's GitHub"  # (translatable)
...
BASE_URL = "/"
BLOG_EMAIL = "shadowkyogre.public@gmail.com"
BLOG_DESCRIPTION = "GitHub sites for all my github projects"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ((
            ...
            ("/QTarot","QTarot"),
            ("/QArithmancy","QArithmancy"),
            ("/QBioBeat","QBioBeat"),
            ("/NCDM","NCDM"),
            ("/systemd-unit-converter","systemd Unit Converter"),
            ("/ninit-boot","ninit boot defaults"),
            ),
        "Originals"),
        ((
...
# which ones are we using for our posts?
post_compilers = {
    "markdown": ('.md', '.mdown', '.markdown'),
}
...
MARKDOWN_EXTENSIONS = ['tables', 'fenced_code', 'nl2br', 'strkundr', 'codehilite', 'toc']
